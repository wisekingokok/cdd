...
/**
 * colorful arc progress bar Created by shinelw on 12/4/15.
 */
public class ProgressWheel extends View {
	...
	private int aniSpeed = 5000;//控制滑动速度
	...
	private String longDegreeColor = "#e0f7ff";
	private String shortDegreeColor = "#e0f7ff";
	private String bgArcColor = "#e0f7ff";
	...
	private void initView() {
		...
		diameter = 1 * getScreenWidth() / 6;//控制顯示的大小
		// 弧形的矩阵区域
		bgRect = new RectF();
