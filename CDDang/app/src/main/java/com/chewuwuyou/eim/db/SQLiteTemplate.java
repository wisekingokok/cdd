...
public class SQLiteTemplate {
	 ...
	 * 传入的内容
	 */
	protected String mContent = "content";
	...
	// public int updateByCondition(String table, String whereClause, String[]
	// whereArgs) {
	// try {
	// dataBase = dBManager.openDatabase();
	// return dataBase.update(table, null, whereClause, whereArgs);
	// } catch (Exception e) {
	// e.printStackTrace();
	// } finally {
	// if (!isTransaction) {
	 ...
	 * @return
	 */
	public int updatefileNameByContent(String table, String content, ContentValues values) {
		try {
			dataBase = dBManager.openDatabase();
			return dataBase.update(table, values, mContent + "=?", new String[] { content });
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			if (!isTransaction) {
	 ...
	 * @return
	 */
	public <T> List<T> queryForList(RowMapper<T> rowMapper, String table, String[] columns, String selection, String[] selectionArgs, String groupBy,
	 ...
	 * 更新数据
	 */
	public void updateFileName(String fileName, String messageContent) {
		try {
			dataBase = dBManager.openDatabase();
			dataBase.execSQL("update  im_msg_his set fileName =" + fileName + "where content =" + messageContent);
		} catch (Exception e) {
