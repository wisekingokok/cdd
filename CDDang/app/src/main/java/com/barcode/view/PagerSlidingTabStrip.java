...
import com.chewuwuyou.app.ui.OrderDetailsActivity;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabTextColor = 0xff242424;
...
//		dividerColor = a.getColor(R.styleable.PagerSlidingTabStrip_dividerColor, dividerColor);
		...
		dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_dividerPaddinger, dividerPadding);
		...
		textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_textAllCapser, textAllCaps);
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				//tab.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(R.drawable.about_cdd_pic1), null);
				
				
				if (i == OrderDetailsActivity.orderId)		
				{
					//tab.setTypeface(Typeface.create(Typeface.SERIF, Typeface.BOLD));
					tab.setTextColor(0xff4aceec);
				}
				
				DisplayMetrics dm = getResources().getDisplayMetrics();
				tab.setPadding((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, dm), 0, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, dm), 0);
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position)
		{
			...
			for (int i=0; i<tabsContainer.getChildCount(); i++)
			{
				...
				tab.setTypeface(Typeface.create(Typeface.SERIF, Typeface.NORMAL));
				tab.setTextColor(0xff242424);
			}
