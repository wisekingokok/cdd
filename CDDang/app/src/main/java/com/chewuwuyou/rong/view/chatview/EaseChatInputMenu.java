    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if (emojiconMenu == null) {
            ...
            if (emojiconGroupList == null) {
                ...
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.d_hehe, Arrays.asList(EaseDefaultEmojiconDatas.createData(context))));
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.section0_emotion0, Arrays.asList(EaseDefaultEmojiconDatas.createGifData(context)), EaseEmojicon.Type.BIG_EXPRESSION));
            }
    ...
    protected void processChatMenu() {
        ...
        emojiconMenu.setEmojiconMenuListener(new EaseEmojiconMenuBase.EaseEmojiconMenuListener() {
            ...
            public void onExpressionClicked(EaseEmojicon emojicon) {
                if (emojicon.getType() != EaseEmojicon.Type.BIG_EXPRESSION) {//点击颜文字
                    if (emojicon.getEmojiText() != null) {
//                        chatPrimaryMenu.onEmojiconInputEvent(EaseSmileUtils.getSmiledText(context, emojicon.getEmojiText()));
                        chatPrimaryMenu.onEmojiconInputEvent(ExpressionUtil.getFace(context, emojicon.getIcon()));
                    }
                } else {//点击大图
                    if (listener != null) {
