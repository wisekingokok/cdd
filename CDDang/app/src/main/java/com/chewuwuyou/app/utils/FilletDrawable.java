 ...
 */
public class FilletDrawable extends Drawable {
	...
	public FilletDrawable(Bitmap bitmap) {
		this(bitmap, 0);
	}

	public FilletDrawable(Bitmap bitmap, int margin) {
		this.margin = margin;
		this.oBitmap = bitmap;
	...
	public void draw(Canvas canvas) {
		...
		canvas.drawRoundRect(mRect, margin, margin, paint);
