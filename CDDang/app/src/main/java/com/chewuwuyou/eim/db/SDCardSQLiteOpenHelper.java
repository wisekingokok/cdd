...
public abstract class SDCardSQLiteOpenHelper {
    ...
    public File getDatabasePath(String name) throws Exception {
        ...
        if (Environment.getExternalStorageState().equals(
            ...
            EXTERN_PATH = CacheTools.getUserData("cacheDir") + dbPath;
            ...
            // android.os.Environment.getExternalStorageDirectory()
            // .getAbsolutePath() + dbPath;
            EXTERN_PATH = mContext.getFilesDir().getAbsolutePath() + dbPath;
            File f = new File(EXTERN_PATH);
            if (!f.exists()) {
                f.mkdirs();
            }
            // Toast.makeText(mContext, "SD卡被占用不可读，请拔下连接电脑USB线，或者解除手机连接电脑的U盘模式",
            // 1);
            // LayoutInflater layoutInflater = (LayoutInflater) mContext
            // .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // View popupView = layoutInflater.inflate(R.layout.exception_popup,
            // null);
            // TextView theText = (TextView) popupView
