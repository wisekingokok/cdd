package com.chewuwuyou.eim.comm;
...
public class Constant {
     ...
     * Ping失败的ACTION和KEY
     */
    public static final String ACTION_PING_OUT = "ping_out";
    public static final String PING_OUT_KEY = "ping_out_key";

    /**
     * Contact Service的ACTION和KEY
     */
    public static final String CONTACT_STARTED = "contact_started";
    public static final String CONTACT_STARTED_KEY = "contact_started_key";

    /**
     * Chat Service的ACTION和KEY
     */
    public static final String CHAT_STARTED = "chat_started";
    public static final String CHAT_STARTED_KEY = "chat_started_key";

    /**
     * SystemMsg Service的ACTION和KEY
     */
    public static final String SYSTEM_MSG_STARTED = "system_msg_started";
    public static final String SYSTEM_MSG_STARTED_KEY = "system_msg_started_key";

    /**
     * ReConnect Service的ACTION和KEY
     */
    public static final String RE_CONNECT_STARTED = "reconnect_started";
    public static final String RE_CONNECT_STARTED_KEY = "reconnect_started_key";
    ...
    public static final int LOGIN_INFO_UNFULFILL = 6;// 链接信息不足，通常是用空用户名在登陆
    public static final int ALREADY_LOGINED = 7;// 已经登录咯
    ...
    public static final String NO_GROUP_FRIEND = "分组车友";// 所有好友
    /**
     * 系统消息
     */
    ...
    public static final String ADD_FRIEND_QEQUEST = "add_friend";// 系统消息关键字
    /**
     * 请求某个操作返回的状态值
     */
    ...
    public static String CAR_COORD = "";
     ...
     * 记录 用户ID
     */
    public static int USER_ID;// 记录用户ID
    /**
     * 标识客服小叮
     */
    public static String XIAODING = "xiaoding@iz232jtyxeoz";
    public static String XIAODANG = "xiaodang@iz232jtyxeoz";
    /**
     * 设置通知的唯一ID
     */
    public static String NOTIFICATION_ID="2016";

    /**
     * 通知可重复显示ID
     */
    public static String NOTIFICATION_SHOW_ID="2017";
}
