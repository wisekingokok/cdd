...
public class WaveView extends LinearLayout {
	...
	private final int DEFAULT_ABOVE_WAVE_COLOR = Color.parseColor("#00BFFF");//#00BFFF #003778
	private final int DEFAULT_BLOW_WAVE_COLOR = Color.parseColor("#00BFFF");//
	...
	public WaveView(Context context, AttributeSet attrs) {
		...
		mAboveWaveColor = attributes
				.getColor(R.styleable.WaveView_above_wave_color,
						DEFAULT_ABOVE_WAVE_COLOR);
		mBlowWaveColor = attributes.getColor(
				R.styleable.WaveView_blow_wave_color, DEFAULT_BLOW_WAVE_COLOR);
		mProgress = attributes.getInt(R.styleable.WaveView_progress,
				DEFAULT_PROGRESS);
		mWaveHeight = attributes.getInt(R.styleable.WaveView_wave_height,
				MIDDLE);
		mWaveMultiple = attributes.getInt(R.styleable.WaveView_wave_length,
				LARGE);
