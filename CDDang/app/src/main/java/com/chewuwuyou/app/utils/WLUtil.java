...
import com.chewuwuyou.app.alipay.Base64;
...
public class WLUtil {
    ...
    // 电商ID
    private static String EBusinessID = "1255767";
    // 电商加密私钥，快递鸟提供，注意保管，不要泄漏
    private static String AppKey = "7a55f2e4-3a31-467f-baf8-0c3068bb86fe";
    // 请求url
    private static String ReqURL = "http://api.kdniao.cc/Ebusiness/EbusinessOrderHandle.aspx";

    /**
     * Json方式 查询订单物流轨迹
     * @param expCode 物流公司代码
     * @param expNo 物流单号
     * @return
     * @throws Exception
     */
