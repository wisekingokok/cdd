...
public class BalanceOrderGridAdapter extends BaseAdapter {
	...
	public BalanceOrderGridAdapter(List<Map<String, Object>> listItems,
	...
	public View getView(int position, View arg1, ViewGroup arg2) {
		...
		tv.setText((String) listItems.get(position).get("ordertye"));
		// 选中时，改变背景色
