...
public class OrderQueryAdapter extends BaseAdapter {
    ...
    public OrderQueryAdapter(Context context, List<ValueTask> mTasks) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ValueTask task = mTasks.get(position);
        ...
        if (task.getStatus().equals("2") && (task.getFacilitatorId().equals("0") || task.getFacilitatorId().equals(""))
            ...
            listItemView.mTextOrdertime.setText(task.getPubishTime().substring(0, 19));
            ...
            listItemView.mOrderTimeTV.setText(task.getPubishTime().substring(0, 19));// 订单时间
...
//                    if (task.getExactPhone().equals(CacheTools.getUserData("telephone"))) {//处理门店录单,处理人电话是我自己
//
//                        Intent intent = new Intent(mContext, ChatActivity.class);
//                        intent.putExtra("to", task.getUserId() + "@iz232jtyxeoz");
...
//                        } else {
                    Intent intent = new Intent(mContext, ChatActivity.class);
                    intent.putExtra("to", task.getFlag().equals("3") ? task.getFacilitatorId() + "@iz232jtyxeoz" : task.getUserId() + "@iz232jtyxeoz");
                    intent.putExtra("title", task.getName());
                    mContext.startActivity(intent);
//                        }
//                    }
    ...
    private View createViewByMessage(ValueTask task) {
