...
public class localImg {
	...
	public static void saveBitmap(Bitmap bm, String path, String picName) {
		Log.e("xxx", "保存图片到本地 path  " + path);
		Log.e("xxx", "保存图片到本地 name  " + picName);
	...
	public static Bitmap compressImage(Bitmap image) {
		...
		while (baos.toByteArray().length / 1024 > 100) { // 循环判断如果压缩后图片是否大于100kb,大于继续压缩
			...
			image.compress(Bitmap.CompressFormat.JPEG, 0, baos);// 这里压缩options%，把压缩后的数据存放到baos中
			options -= 10;// 每次都减少10
	...
	public static Bitmap compImg(Bitmap image) {
		...
		float hh = 720f;// 这里设置高度为480f
		float ww = 1280f;// 这里设置宽度为800f
