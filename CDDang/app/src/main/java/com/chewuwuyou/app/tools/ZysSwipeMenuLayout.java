 ...
 */
public class ZysSwipeMenuLayout extends FrameLayout {
    ...
    private ZysSwipeMenuView mMenuView;
    private int mDownX;
    ...
    public ZysSwipeMenuLayout(View contentView, ZysSwipeMenuView menuView) {
    ...
    private ZysSwipeMenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    private ZysSwipeMenuLayout(Context context) {
        super(context);
    }
    ...
    public ZysSwipeMenuView getMenuView() {
        return mMenuView;
    }
