...
public class UpdatePayPasswordActivity extends CDDBaseActivity implements
	...
	public static UpdatePayPasswordActivity mUpdatePayPasswordActivity = null;
	...
	public void onClick(View v) {
		...
		case R.id.forget_pay_password_tv:// 跳转至忘记支付密码
			Intent intent = new Intent(UpdatePayPasswordActivity.this,
		...
		case R.id.forget_paypass_tv:
			Intent forgetIntent = new Intent(UpdatePayPasswordActivity.this,
					VerifyPayActivity.class);
			forgetIntent.putExtra("clilckType", Constant.CLICK_FORGET_PAYPASS);
	...
	private void toClass() {
				...
				case Constant.NET_DATA_SUCCESS:
					...
					try {
						...
						if (jo.getString("re").equals("true")) {
							...
							intent = new Intent(UpdatePayPasswordActivity.this,SetPassWord.class);
							intent.putExtra("isUpdate", IS_UPDATE_PASSWORD);
							intent.putExtra("Identification", getIntent().getIntExtra("Identification", 0));
							startActivity(intent);
							finishActivity();
						} else {
							ToastUtil.toastShow(UpdatePayPasswordActivity.this,
									"旧密码不正确");
						}
		...
		}, params, NetworkUtil.JUDGE_PAY_PASSWORD, false, 0);
